...
Vale la pena hablar primero del efecto de interferencia. La interferencia es el efecto de la recombinación de dos ondas en movimiento; patrones de interferencia ocurren cuando estas dos ondas presentan una diferencia de fase. Es un fenómeno muy fácil de ver al dejar caer dos piedras en una alberca y hacen olas: se presenta interferencia cuando estas olas se superponen. Sin embargo, en el contexto del campo electromagnético, existen varios ejemplos que sirven para dejarlo en claro.

\subsubsection{Estadística de fotones}\label{estadistica}
g1 y g2
\subsubsection{Cuantización del campo}\label{optica cuantica}
