...
Para realizar la comunicación entre el TDC y el resto de los sistemas del laboratorio, fue necesario escribir una paquetería de uso. El diagrama de flujo para el desarrollo de la paquetería se encuentra en \textbf{FLOWCHART}.
...
\textbf{DIAGRAMA DE SISTEMAS DE CONTROL IMAGEN Y ADQ}
...
\caption{$\g{2}(\tau)$ para un haz de luz coherente.}\label{fig:g2}
\end{figure}
