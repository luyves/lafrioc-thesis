...
El objetivo principal de este capítulo fue el de realizar mediciones con el interferómetro para luz láser y así verificar el buen funcionamiento del sistema de adquisición de datos. Dentro del archivo de configuración \code{config.py} del programa de adquisición se fijó un tamaño de búfer de 1,000,000 de eventos y se guardaron 70+ millones de cuentas