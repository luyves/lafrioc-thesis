...
\divr\D &= \rho, \\
\divr\B &= 0, \\
\curl\times\E &= -\frac{\partial \B}{\partial t}, \\
...
Tomando el rotacional de la ecuación \ref{faraday}:
\begin{equation*}
...
\end{equation}
y el hecho que $\divr\E = 0$ por la ecuación \ref{gauss_elec}, nos queda
\begin{equation}
...
\subsubsection{Estadística de fotones}
g1 y g2
\subsubsection{Cuantización del campo}
