...
Se reporta un valor de $\g{2}(0) = 1.0006\pm0.0012$ y un promedio de $\overline{\g{2}} = 1.0007\pm0.0014$, que está en buena concordancia con el valor obtenido de la teoría. Este resultado responde bien al propósito de este trabajo: el desarrollo de un esquema experimental en anticipación a experimentos de FWM en átomos fríos. 