...
Una secuencia experimental típica para un proceso de FWM en átomos fríos tiene una ventana temporal pequeña de apenas unos cuantos microsegundos\cite{Cho2013}. Esta secuencia requiere la sincronización de muchos eventos simultáneos como obturar de láseres, prender campos magnéticos y controlar disparadores de cámaras o fotodiodos para la captura de datos. Uno busca, además, repetir controladamente cientos de experimentos para justificar un análisis estadístico sobre los datos obtenidos. Por lo tanto, estos experimentos exigen un sistema de recolección de datos rápido, que pueda comunicarse con los intrumentos relevantes y procese a tiempo las señales generadas.
