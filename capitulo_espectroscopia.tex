...
Al usar átomos alcalinos, se parte de la estructura de sus niveles energéticos. Para un átomo

\subsubsection{MOT}
Una descripción teórica a profundidad de los mecanismos de una MOT no forma parte de esta tesis. Sin embargo, una introducción breve basada en \cite{Adrian, Foot} resulta útil.
