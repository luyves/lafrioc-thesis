...
Por un lado, el enfriamieneto láser es una manifestación de una fuerza radiativa que Ashkin llamó \textit{fuerza de scattering}\cite{PhysRevLett.24.156}. Por el otro lado, para atrapar átomos se aprovecha su momento dipolar magnético con el uso de un campo cuadrupolar externo\cite{PhysRevLett.59.2631}.
